...
export default function LandingServices() {
    return (
        <section id="services" className="container mb-16 scroll-mt-24">
            <div className="text-center mb-12">
                <h2 className="text-4xl font-medium mb-4 text-foreground md:text-5xl">
                    Dịch vụ
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Chúng tôi cung cấp các dịch vụ phát triển phần mềm chuyên nghiệp,
                    giúp bạn tối ưu hóa quy trình làm việc và tăng hiệu suất kinh doanh.
                </p>
            </div>
